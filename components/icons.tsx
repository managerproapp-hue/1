...
export const PiggyBankIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M10 17V15"></path>
    <path d="M10 9H10.01"></path>
    <path d="M2 9.5C2 7.23858 3.79086 5.5 6 5.5H18C20.2091 5.5 22 7.23858 22 9.5V10.5C22 12.7614 20.2091 14.5 18 14.5H15.5C14.8333 14.5 14.2974 14.8143 14 15.2969L12 18.2969C11.5333 19.0062 10.4667 19.0062 10 18.2969L8 15.2969C7.70256 14.8143 7.16667 14.5 6.5 14.5H6C3.79086 14.5 2 12.7614 2 10.5V9.5Z"></path>
  </svg>
);

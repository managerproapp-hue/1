...
const BackupView: React.FC<BackupViewProps> = ({ setActiveTab }) => {
    ...
    const handleRestoreFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file && file.type === 'application/json') {
            handleRestoreBackup(file, () => setActiveTab('dashboard'));
        } else {
            alert('Por favor, selecciona un archivo de copia de seguridad JSON válido.');
        }
    ...
    return (
        <div className="space-y-8 max-w-lg mx-auto">
            ...
            <div className="bg-slate-800 p-6 rounded-xl shadow-lg">
                ...
                <button onClick={handleDownloadBackup} className="w-full flex items-center justify-center space-x-2 bg-pink-600 hover:bg-pink-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors">
